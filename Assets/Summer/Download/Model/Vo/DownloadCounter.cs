...
namespace Summer.Download.Model.Vo
{
    ...
    {
        private readonly CachedLinkedList<DownloadCounterNode> m_DownloadCounterNodes;
        ...
        public DownloadCounter(float updateInterval, float recordInterval)
        {
            ...
            m_DownloadCounterNodes = new CachedLinkedList<DownloadCounterNode>();
        ...
        public void Update(float elapseSeconds, float realElapseSeconds)
        {
            ...
            while (m_DownloadCounterNodes.Count > 0)
            {
                ...
                ReferenceCache.Release(downloadCounterNode);
