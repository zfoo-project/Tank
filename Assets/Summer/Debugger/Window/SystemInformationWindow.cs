    ...
    public sealed class SystemInformationWindow : ScrollableDebuggerWindowBase
    {
        protected override void OnDrawScrollableWindow()
        {
            ...
            GUILayout.BeginVertical("box");
            {
                ...
                DrawItem("Processor Frequency", StringUtils.Format("{} MHz", SystemInfo.processorFrequency.ToString()));
                DrawItem("System Memory Size", StringUtils.Format("{} MB", SystemInfo.systemMemorySize.ToString()));
