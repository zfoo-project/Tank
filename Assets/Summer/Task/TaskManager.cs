...
namespace Summer.Task
{
    ...
    /// 任务管理器。
    /// </summary>
    sealed class TaskManager : AbstractManager, ITaskManager
    {
        private readonly CachedLinkedList<TaskBase> m_Tasks;
        ...
        public TaskManager()
        {
            m_Tasks = new CachedLinkedList<TaskBase>();
            m_Serial = 0;
        }
        ...
        {
            T task = ReferenceCache.Acquire<T>();
