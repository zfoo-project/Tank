...
namespace Summer.Sound
{
    ...
    public sealed class SoundGroup
    {
        ...
        private readonly AudioMixerGroup m_SoundGroupHelper;
        private readonly List<SoundAgentMono> m_SoundAgents;
        ...
        public SoundGroup(string name, AudioMixerGroup audioMixerGroup, bool avoidBeingReplacedBySamePriority, bool mute, float volume)
        {
            ...
            m_Name = name;
            m_SoundGroupHelper = audioMixerGroup;
            m_SoundAgents = new List<SoundAgentMono>();
        ...
        public void AddSoundAgentMono(SoundAgentMono soundAgentMono)
        {
            soundAgentMono.soundGroup = this;
            m_SoundAgents.Add(soundAgentMono);
        }
        ...
        public SoundAgentMono PlaySound(int serialId, object soundAsset, PlaySoundParams playSoundParams)
        {
            SoundAgentMono candidateAgent = null;
            foreach (var soundAgent in m_SoundAgents)
            {
            ...
            {
                Log.Warning("声音优先级太低，忽略");
                return null;
            }

            candidateAgent.SetSoundAsset(soundAsset);
        ...
        public void StopAllLoadedSounds()
        {
            foreach (var soundAgent in m_SoundAgents)
            {
                if (soundAgent.IsPlaying)
                {
                    soundAgent.Stop(SoundConstant.DefaultFadeOutSeconds);
                }
            }
        }
