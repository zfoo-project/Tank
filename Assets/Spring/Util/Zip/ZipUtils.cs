    ...
    public abstract class ZipUtils
    {
        ...
        public static bool Compress(byte[] bytes, int offset, int length, Stream compressedStream)
        {
            ...
            catch (Exception exception)
            {
                ...
                throw new Exception(
                    StringUtils.Format("Can not compress with exception '{}'.", exception.ToString()), exception);
            }
        }
        ...
        public static bool Decompress(byte[] bytes, int offset, int length, Stream decompressedStream)
        {
            ...
            catch (Exception exception)
            {
                ...
                throw new Exception(
                    StringUtils.Format("Can not decompress with exception '{}'.", exception.ToString()), exception);
            }
        }
