...
namespace Summer.FileSystem.Model
{
    ...
    sealed class FileSystem : IFileSystem
    {
        ...
        public bool WriteFile(string name, byte[] buffer, int startIndex, int length)
        {
            ...
            {
                throw new GameFrameworkException(StringUtils.Format("Name '{}' is too long.", name));
            }
        ...
        public bool RenameFile(string oldName, string newName)
        {
            ...
            {
                throw new GameFrameworkException(StringUtils.Format("New name '{}' is too long.", newName));
            }
        ...
        private int AllocString(string value)
        {
            ...
            else
            {
                ...
                if (index < m_HeaderData.MaxFileCount)
                {
                    ...
                    RandomUtils.GetRandomBytes(bytes);
            ...
            if (stringIndex < 0)
            {
                throw new GameFrameworkException("Alloc string error.");
            }
        ...
        public static long GetUpBoundClusterOffset(long offset)
        {
