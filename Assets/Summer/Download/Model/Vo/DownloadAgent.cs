...
namespace Summer.Download.Model.Vo
{
    ...
    public sealed class DownloadAgent : ITaskAgent<DownloadTask>, IDisposable
    {
        ...
        public StartTaskStatus Start(DownloadTask task)
        {
            ...
            string downloadFile = StringUtils.Format("{}.download", m_Task.DownloadPath);
        ...
        private void OnDownloadAgentHelperComplete(object sender, DownloadAgentHelperCompleteEventArgs e)
        {
            ...
            {
                throw new GameFrameworkException("download error.");
            }
            ...
            File.Move(StringUtils.Format("{}.download", m_Task.DownloadPath), m_Task.DownloadPath);
        ...
        private void OnDownloadAgentHelperError(object sender, DownloadAgentHelperErrorEventArgs e)
        {
            ...
            {
                File.Delete(StringUtils.Format("{}.download", m_Task.DownloadPath));
            }
